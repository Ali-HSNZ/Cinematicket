     ...
     return (  
          <header className="w-full bg-white p-4 flex flex-row justify-between">
               ...
               <div className="w-1/2 flex gap-x-4 items-center ">
                    <svg className="w-24"  xmlns="http://www.w3.org/2000/svg" width="108.931" height="27.283"  viewBox="0 0 108.931 27.283" >
                   ...
                   <Link href={'/'} className="whitespace-nowrap text-gray-500 hover:bg-red-50 hover:text-red-600 duration-150 flex gap-x-1 items-center py-2 px-2 rounded-lg font-iranyekan-regular text-xs">
                    ...
                    <div className="w-full relative">
                         <svg className="w-[20px] h-[20px] absolute top-2.5 right-2.5 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                         </svg>
                         <input maxLength={60} placeholder="جست‌وجوی فیلم، سینما، کارگردان، بازیگر و ..." type="tel" name="password" className={`placeholder:text-xs placeholder:text-gray-400 w-full bg-gray-50 border-gray-200 hover:border-gray-300 focus:border-gray-300 text-gray-600  py-2 pl-2 pr-10 rounded-md font-iranyekan-regular text-sm border   focus:outline-none`} />
                    </div>
               </div>
               <div className="w-1/2 flex gap-x-4 items-center justify-end ">
                    <Link href={'/'} className="whitespace-nowrap text-gray-500 hover:bg-red-50 hover:text-red-600 duration-150 flex gap-x-1 items-center py-2 px-2 rounded-lg font-iranyekan-regular text-xs">
