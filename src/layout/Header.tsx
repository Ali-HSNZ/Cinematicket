     ...
     return (  
          <header className="w-full bg-white p-4 flex flex-row justify-between">
               ...
               <div className="sm:w-fit lg:w-1/2 flex gap-x-4 items-center justify-end ">
                    ...
                    <Link href={'/dashboard/edit_profile'} className="hidden lg:flex whitespace-nowrap text-gray-500 hover:bg-red-50 hover:text-red-600 duration-150 gap-x-1 items-center py-2 px-2 rounded-lg font-iranyekan-regular text-xs">
                         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
