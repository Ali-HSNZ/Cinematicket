...
const ChangeLocation : React.FC<TModal> = ({open , setOpen}) => {
          ...
          <Modal className='flex justify-center items-center px-4' open={open} onClose={()=> setOpen(false)}>
               <section className='bg-white p-4 w-[700px] rounded-md '>
                    <div className='w-full flex justify-between gap-x-4 items-center'>
                         <h5 className='whitespace-nowrap font-iranyekan-bold text-gray-600'>موقعیت مکانی</h5>
                    ...
                    <ul className='max-h-[350px] overflow-y-auto pl-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 mt-4 text-center'>
                         <li className='flex items-center justify-center gap-x-2 text-center bg-gray-50 hover:bg-gray-100 border border-transparent hover:border-gray-200 cursor-pointer rounded-md p-3 font-iranyekan-regular text-sm text-gray-600'>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
